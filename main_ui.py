...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.addFileButton = QtWidgets.QPushButton(self.layoutWidget)
        ...
        self.labelXAxis = QtWidgets.QLabel(self.layoutWidget)
        self.labelXAxis.setObjectName("labelXAxis")
        self.verticalLayout_2.addWidget(self.labelXAxis)
        self.dropdownXAxis = QtWidgets.QComboBox(self.layoutWidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.XAxisLabel.setText(_translate("MainWindow", "Y-Axis Data"))
        self.addButton.setText(_translate("MainWindow", "Add"))
        self.removeButton.setText(_translate("MainWindow", "Remove"))
        self.clearButton.setText(_translate("MainWindow", "Clear"))
        self.labelXAxis.setText(_translate("MainWindow", "X-Axis Data"))
        self.labelXTitle.setText(_translate("MainWindow", "X-Axis Title"))
        self.lineXTitle.setText(_translate("MainWindow", "X Axis Title"))
        self.labelYTitle.setText(_translate("MainWindow", "Y-Axis Title"))
